...
//                .build();
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        Problem problem = createProblemBuilder(status, problemType, "Um ou mais campos estão inválidos. Faça o preenchimento correto e tente novamente.")
                .userMessage("Um ou mais campos estão inválidos. Faça o preenchimento correto e" +
                        "tente novamente.")
                .timestamp(LocalDateTime.now())
                .build();
