...
import com.algaworks.AprendizadoSpring.core.openapi.model.PageableModelOpenApi;
    ...
    private Consumer<RepresentationBuilder> getProblemaModelReference() {
        return r -> r.model(m -> m.name("Problema")
                .referenceModel(ref -> ref.key(k -> k.qualifiedModelName(
                        q -> q.name("Problema").namespace("com.algaworks.AprendizadoSpring.api.exceptionhandler")))));
    }
